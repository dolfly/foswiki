#!perl
#
# Install script for DownloadZipPlugin
#
...
Foswiki::Extender::install( $PACKAGES_URL, 'DownloadZipPlugin', 'DownloadZipPlugin', @DATA );
...
__DATA__
<<<< MANIFEST >>>>
data/System/DownloadZipPlugin.txt,0644,Documentation page (noci)
lib/Foswiki/Plugins/DownloadZipPlugin.pm,0444,Perl module (noci)
lib/Foswiki/Plugins/DownloadZipPlugin/Config.spec,0444,Configuration (noci)

<<<< DEPENDENCIES >>>>
Archive::Zip,>=1.30,1,perl,Required
