...
sub test_stringForFile {
    my $this = shift;
    my $stringifier = Foswiki::Contrib::SearchEngineKinoSearchAddOn::StringifyPlugins::XLSX->new();

    my $text  = $stringifier->stringForFile($this->{attachmentDir}.'Simple_example.xlsx');
    my $text2 = Foswiki::Contrib::SearchEngineKinoSearchAddOn::Stringifier->stringFor($this->{attachmentDir}.'Simple_example.xlsx');
