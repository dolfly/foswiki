...
sub test_rmtree {
    my $this = shift;
    my $stringifier = Foswiki::Contrib::SearchEngineKinoSearchAddOn::StringifyBase->new();
...
sub test_handler_for {
    ...
    $this->assert($handler->isa("Foswiki::Contrib::SearchEngineKinoSearchAddOn::StringifyPlugins::PDF"), 
