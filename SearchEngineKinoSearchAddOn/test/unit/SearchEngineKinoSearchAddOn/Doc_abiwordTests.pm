...
sub set_up {
    ...
    $Foswiki::cfg{SearchEngineKinoSearchAddOn}{WordIndexer} = 'abiword';
...
sub test_stringForFile {
    my $this = shift;
    my $stringifier = Foswiki::Contrib::SearchEngineKinoSearchAddOn::StringifyPlugins::DOC_abiword->new();
