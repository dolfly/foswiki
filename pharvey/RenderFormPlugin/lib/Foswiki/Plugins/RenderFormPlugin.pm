...
sub initPlugin {
    ...
    Foswiki::Func::registerTagHandler('RENDERFIELD', \&RENDERFIELD);
...
sub RENDERFIELD {
	...
	#SMELL: Assuming a CGI environment
	return Foswiki::Plugins::RenderFormPlugin::Core::handleRENDERFIELD(
		Foswiki::Func::getCgiQuery(), $params, $topic, $web);
}
