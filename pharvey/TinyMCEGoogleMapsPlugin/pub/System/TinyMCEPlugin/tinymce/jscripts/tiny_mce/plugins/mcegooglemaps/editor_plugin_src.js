(function() {
    ...
    tinymce.create('tinymce.plugins.GooglemapsPlugin', { init: function(ed, url) {
        ...
        ed.addCommand('mceGooglemap', function() {
            ed.windowManager.open({ file: url + '/googlemaps.htm', width: 640 + parseInt(ed.getLang('googlemaps.delta_width', 0)), height: 500 + parseInt(ed.getLang('googlemaps.delta_height', 0)), inline: 1 }, { plugin_url: url, plugin_googleMaps_apiKey: foswiki.TinyMCEGoogleMapsPlugin.apiKey, plugin_googleMaps_coordinates: ed.getParam("plugin_googleMaps_coordinates", ""), plugin_googleMaps_showCoordinates: ed.getParam("plugin_googleMaps_showCoordinates", "true"), plugin_googleMaps_locationLookupEnabled: ed.getParam("plugin_googleMaps_locationLookupEnabled", "true") });
        });
