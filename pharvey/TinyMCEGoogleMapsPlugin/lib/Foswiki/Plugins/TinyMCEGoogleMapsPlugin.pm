...
---+ package TinyMCEGoogleMapsPlugin

=cut

package Foswiki::Plugins::TinyMCEGoogleMapsPlugin;
...
our $RELEASE = '15 April 2010';

# Short description of this plugin
# One line description, is shown in the %SYSTEMWEB%.TextFormattingRules topic:
our $SHORTDESCRIPTION = 'Foswiki TinyMCE integration of the mcegooglemap sourceforge project';
...
sub initPlugin {
    ...
    Foswiki::Func::addToHEAD('TINYMCEGOOGLEMAPSPLUGIN::APIKEY',
        '<meta name="foswiki.TinyMCEGoogleMapsPlugin.apiKey" content="%TINYMCEGOOGLEMAPSPLUGIN_APIKEY%"/>');
...
The remainder of this information applies to the TinyMCEGoogleMapsPlugin:

Plugin for Foswiki - The Free and Open Source Wiki, http://foswiki.org/

TinyMCEGoogleMapsPlugin is Copyright (C) 2009-2010 Foswiki Contributors.
...
This license applies to TinyMCEGoogleMapsPlugin and to any derivatives.
